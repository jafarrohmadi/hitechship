...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.terminals.update", [$terminal->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.terminal.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $terminal->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('power_backup') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="power_backup" id="power_backup" value="1" {{ $terminal->power_backup || old('power_backup', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('power_main') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="power_main" id="power_main" value="1" {{ $terminal->power_main || old('power_main', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('sleep_schedule') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="sleep_schedule" id="sleep_schedule" value="1" {{ $terminal->sleep_schedule || old('sleep_schedule', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('battery_low') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="battery_low" id="battery_low" value="1" {{ $terminal->battery_low || old('battery_low', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('speeding_start') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="speeding_start" id="speeding_start" value="1" {{ $terminal->speeding_start || old('speeding_start', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('speeding_end') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="speeding_end" id="speeding_end" value="1" {{ $terminal->speeding_end || old('speeding_end', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('modem_registration') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="modem_registration" id="modem_registration" value="1" {{ $terminal->modem_registration || old('modem_registration', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('geofence_in') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="geofence_in" id="geofence_in" value="1" {{ $terminal->geofence_in || old('geofence_in', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('geofence_out') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="geofence_out" id="geofence_out" value="1" {{ $terminal->geofence_out || old('geofence_out', 0) === 1 ? 'checked' : '' }}>
