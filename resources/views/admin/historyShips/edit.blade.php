    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.history-ships.update", [$historyShip->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('history_ids') ? 'is-invalid' : '' }}" type="text" name="history_ids" id="history_ids" value="{{ old('history_ids', $historyShip->history_ids) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sin') ? 'is-invalid' : '' }}" type="text" name="sin" id="sin" value="{{ old('sin', $historyShip->sin) }}">
                @if($errors->has('sin'))
                    <div class="invalid-feedback">
                        {{ $errors->first('sin') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min') ? 'is-invalid' : '' }}" type="text" name="min" id="min" value="{{ old('min', $historyShip->min) }}">
                @if($errors->has('min'))
                    <div class="invalid-feedback">
                        {{ $errors->first('min') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('region_name') ? 'is-invalid' : '' }}" type="text" name="region_name" id="region_name" value="{{ old('region_name', $historyShip->region_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('receive_utc') ? 'is-invalid' : '' }}" type="text" name="receive_utc" id="receive_utc" value="{{ old('receive_utc', $historyShip->receive_utc) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('message_utc') ? 'is-invalid' : '' }}" type="text" name="message_utc" id="message_utc" value="{{ old('message_utc', $historyShip->message_utc) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payload') ? 'is-invalid' : '' }}" type="text" name="payload" id="payload" value="{{ old('payload', $historyShip->payload) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ota_message_size') ? 'is-invalid' : '' }}" type="text" name="ota_message_size" id="ota_message_size" value="{{ old('ota_message_size', $historyShip->ota_message_size) }}">
