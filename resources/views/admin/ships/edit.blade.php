    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.ships.update", [$ship->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ship_ids') ? 'is-invalid' : '' }}" type="text" name="ship_ids" id="ship_ids" value="{{ old('ship_ids', $ship->ship_ids) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $ship->name) }}" required>
                @if($errors->has('name'))
                    <div class="invalid-feedback">
                        {{ $errors->first('name') }}
                    </div>
