            ...
            success: function (data) {
                ...
                for (let i in data) {
                    ...
                    if(i !== '') {
                        ...
                        getDataHistoryShip = getDataHistoryShip + '<tr class="header2" style="background-color: #023342; color:#fff;"><td colspan="2" style ="height:19px; padding-left:5px; font-weight: 660;"> Unassigned</td></tr>';
                    }
                            ...
                            if (data[i][j][k]['name'] != null) {
                                if(i !== '') {
                                    ...
                                    getDataHistoryShip = getDataHistoryShip +
                                        ...
                                        '<td style="padding-left: 0px; font-weight: 660; text-transform: uppercase;">' + data[i][j][k]['name'] + '</td>' +
                                        '</tr>';
                                }else {
                                    getDataShip = getDataShip + '<tr class="row">' +
