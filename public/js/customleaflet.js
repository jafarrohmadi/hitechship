            ...
            success: function (data) {
                ...
                for (let i in data) {
                    ...
                    if(i !== '') {
                        ...
                        getDataHistoryShip = getDataHistoryShip + '<tr class="header2" style="background-color: #023342; color:#fff;"><td colspan="2" style ="height:19px; padding-left:5px; font-weight: 400;">' + damask + '</td></tr>';
                    }
                    for (const j in data[i]) {
                        ...
                        if(i !== '') {
                            ...
                            getDataHistoryShip = getDataHistoryShip + '<tr class="header"><td colspan="2" style="padding-left: 10px" height:18px; font-weight: 400;>' + damaskus + '</td></tr>';
                        }else {
                            getDataShip = getDataShip + '<tr class="header"><td colspan="4" style="padding-left: 7px"><input type="checkbox" id="top' + topKing + '" name="' + king + '" checked="checked"/>&nbsp;' + damaskus + '</td> </tr>';
                            getDataHistoryShip = getDataHistoryShip + '<tr class="header" style="height:20px;"><td colspan="2" style="padding-left: 10px; font-weight: 400;">' + damaskus + '</td>/tr>';
                        }
                            ...
                            if (data[i][j][k]['name'] != null) {
                                if(i !== '') {
                                    ...
                                    getDataHistoryShip = getDataHistoryShip +
                                        ...
                                        '<td style="padding-left: 0px; font-weight: 400;">' + data[i][j][k]['name'] + '</td>' +
                                        '</tr>';
                                }else {
                                    getDataShip = getDataShip + '<tr class="row">' +
